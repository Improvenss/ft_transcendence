...
import { IFriend, IOnChannelProps } from "./iChannel";
...
function InfoChannel({ selectedChannel, isInfoChannelActive, setIsInfoChannelActive }: IOnChannelProps) {
	...
	return (
		<>
			{selectedChannel && (
				<div id="infoChannel" style={{ visibility: isInfoChannelActive ? 'visible' : 'hidden', display: isInfoChannelActive ? 'flex' : 'none' }}>
